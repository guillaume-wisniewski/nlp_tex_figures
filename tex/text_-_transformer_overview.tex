...
%\newcommand{\transformer}{\makecell{Modèle de langue \\ (architecture transformeur)}}


% English
\newcommand{\initial}{initial \\ representation}
\newcommand{\final}{contextualized \\ representation}
\newcommand{\transformer}{\makecell{Model of language \\ (\texttt{Transformer})}}
...
\begin{tikzpicture}[ampersand replacement=\&]
    ...
    \node [above=of input, minimum height=3em, minimum width=12cm, draw=apricot, rounded corners, line width=2pt, fill=apricot!50] (transformer) {\transformer};
