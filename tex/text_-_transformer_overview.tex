...
\begin{tikzpicture}[ampersand replacement=\&]
    ...
    \node (transformer) [above=of input, minimum height=3em, minimum width=12cm, draw=apricot, rounded corners, line width=2pt, fill=apricot!50] (transformer) {\makecell{Transformer Language Model}};
